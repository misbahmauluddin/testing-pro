...
class PropertyForm extends FormAbstract
{
    ...
    public function buildForm()
    {
        ...
        $this
            ...
            ->add('rooms_available', 'number', [
                'label'      => trans('plugins/real-estate::property.form.rooms_available'),
                'label_attr' => ['class' => 'control-label'],
                'wrapper'    => [
                    'class' => 'form-group mb-3 col-md-3',
                ],
                'attr'       => [
                    'placeholder' => trans('plugins/real-estate::property.form.rooms_available'),
                ],
            ])
            ->add('number_capacity', 'number', [
                'label'      => trans('plugins/real-estate::property.form.number_capacity'),
                'label_attr' => ['class' => 'control-label'],
                'wrapper'    => [
                    'class' => 'form-group mb-3 col-md-3',
                ],
                'attr'       => [
                    'placeholder' => trans('plugins/real-estate::property.form.number_capacity'),
                ],
            ])
