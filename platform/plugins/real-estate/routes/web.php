...
Route::group(['namespace' => 'Botble\RealEstate\Http\Controllers', 'middleware' => ['web', 'core']], function () {
    ...
    Route::group(['prefix'     => BaseHelper::getAdminPrefix() . '/real-estate','middleware' => 'auth',], function () {
        ...
        Route::group(['prefix' => 'accounts/customer', 'as' => 'customer.'], function () {

            Route::resource('', 'CustomerAccountController')
                ->parameters(['' => 'customer']);

            Route::delete('items/destroy', [
                'as'         => 'deletes',
                'uses'       => 'CustomerAccountController@deletes',
                'permission' => 'account.destroy',
            ]);

            Route::get('list', [
                'as'         => 'list',
                'uses'       => 'CustomerAccountController@getList',
                'permission' => 'account.index',
            ]);
