                            ...
                            <div class="col-sm-12">
                                <table class="table table-striped table-bordered">
                                    ...
                                    @if ($property->rooms_available)
                                        <tr>
                                            <td>{{ __('Rooms Available') }}</td>
                                            <td><strong>{{ number_format($property->rooms_available) }}</strong></td>
                                        </tr>
                                    @endif
                                    @if ($property->number_capacity)
                                        <tr>
                                            <td>{{ __('Capacity (Person)') }}</td>
                                            <td><strong>{{ number_format($property->number_capacity) }}</strong></td>
                                        </tr>
                                    @endif
                            ...
                            <div class="row">
                                ...
                                @foreach($property->facilities as $facility)
                                    <div class="col-sm-4">
                                        ...
                                        @else
                                            <p><i class="@if ($facility->icon) {{ $facility->icon }} @else fas fa-check @endif text-orange text0i"></i> {{ $facility->name }} <!-- - {{ $facility->pivot->distance }} {{ __('km') }} -->'
                                        </p>
                                        @endif
                                    </div>
                                @endforeach
